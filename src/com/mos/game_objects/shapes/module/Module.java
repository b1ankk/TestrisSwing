...
public class Module extends Entity
{
    ...
    public Module(Vector position, int width, int height, Sprite sprite)
    {
        ...
        int x = (super.position.getX() - GameScene.BOARD_POSITION_X - GameScene.getBoard().BORDER_THICKNESS) / Shape.MODULE_SIDE_PIXEL_LENGTH;
        int y = (super.position.getY() - GameScene.BOARD_POSITION_Y - GameScene.getBoard().BORDER_THICKNESS) / Shape.MODULE_SIDE_PIXEL_LENGTH;
