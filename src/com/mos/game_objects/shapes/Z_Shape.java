...
public class Z_Shape extends Shape
{
    ...
    public Z_Shape()
    {
        ...
        Module m1 = new Module(SPAWN_POSITION.add(new Vector(0, 0).multiply(dif)), dif, dif, sprite);
        Module m2 = new Module(SPAWN_POSITION.add(new Vector(-1, 0).multiply(dif)), dif, dif, sprite);
