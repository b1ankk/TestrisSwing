...
public class SpriteHolder
{
    ...
    private final Map<String, SubSpriteFileProperties> paths = new HashMap<>();
        ...
        paths.forEach(
            (path, sfp) ->
            {
                if (sfp == null) {
                    ...
                    spriteLoader.loadSpritesFromSheet(
                        path,
                        sfp.getWidth(), sfp.getHeight(),
                        sfp.getSubSpriteAmount(), sfp.getNames()
                    );
                }
            });
