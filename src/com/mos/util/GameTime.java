...
public class GameTime
{
    ...
    //TO DO
    //DELTA TIME
    private static HashMap<String, Long> nanoTimers = new HashMap<>();
...
//    public static void subtractFromTimer(String name, long value)
//    {
//        timers.replace(name, timers.get(name) - value);
//    }
